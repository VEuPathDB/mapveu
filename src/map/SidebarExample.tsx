...
import { Sidebar, Tab } from './SidebarReactDK'
//DKDK modified version of typescript definition for react-leaflettaken
import { SidebarProps } from './react-leaflet-sidebarv2-DK'
...
export default function SidebarExample(props: SidebarProps) {
  ...
  return (
    ...
    >
        ...
        <Tab id="settings" header="Settings" icon="fas fa-cog" anchor="bottom">
            <p>Change settings</p>
        </Tab>
    </Sidebar>
  );
